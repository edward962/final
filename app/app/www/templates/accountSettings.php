<ion-view title="Account settings">
    <ion-content overflow-scroll="true" padding="true" scroll="true" class="has-header">
        ...
        <form class="list"   ng-submit="submit(action, username, email, profile_picture, first_name, last_name, phone_number)" enctype="multipart/form-data">
            ...
            <ion-list>
                ...
                <label class="item item-input">
                    ...
                    <input type="file" name="profile_picture" ng-model="profile_picture" placeholder="" value="">
                </label>
								<label class="item item-input">
